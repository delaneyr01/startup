    ...
    return (
        ...
        <header>
            ...
            <menu>
                ...
                <li><a href="%PUBLIC_URL%/month_view.html">Month View</a></li>
                <li><a href="%PUBLIC_URL%/week_view.html">Week View</a></li>
                <li><a href="%PUBLIC_URL%/theme.html">Theme</a></li>
                <li><a href="%PUBLIC_URL%/accounts.html">Accounts</a></li>
            </menu>
            </nav>
            <hr />
        </header>
